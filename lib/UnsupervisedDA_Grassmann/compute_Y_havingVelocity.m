...
% moving along the geodesic starting from Y0, with direction A, get the output at time t -- "Exponential map" ... specify different values of t (between 0 and 1) to sample points along the geodesic, to obtain intermediate subspaces
